...
const ADVISOR_THREAT_TRACK_LIMIT = 10;
  ...
  return {
    ...
    cautions: uniqueText([
      ...evidence
        ...
        .sort(
          (left, right) =>
            Number(right.displayText.includes("唯一")) -
              Number(left.displayText.includes("唯一")) ||
