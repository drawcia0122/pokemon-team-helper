...
export const POKEMON_BASE_STAT_DEFINITIONS = [
  { key: "hp", label: "HP", shortLabel: "HP", chartLabel: "HP" },
  { key: "attack", label: "こうげき", shortLabel: "A", chartLabel: "攻" },
  { key: "defense", label: "ぼうぎょ", shortLabel: "B", chartLabel: "防" },
  { key: "specialAttack", label: "とくこう", shortLabel: "C", chartLabel: "特攻" },
  { key: "specialDefense", label: "とくぼう", shortLabel: "D", chartLabel: "特防" },
  { key: "speed", label: "すばやさ", shortLabel: "S", chartLabel: "素早" }
