...
export const POKEMON_NEWS_SOURCE_REGISTRY = {
  "pokemon-japan-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["goods", "game", "event", "card", "anime-video", "collaboration", "competition"], gameTitles: ["ポケモン本編", "Pokémon LEGENDS", "Pokémon Champions"],
  ...
  "pokemon-center-japan": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["goods", "event", "collaboration"], gameTitles: [], automationStatus: "manual", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-go-official-rss": {
    ...
    sourceType: "rss", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "event", "collaboration"], gameTitles: ["Pokémon GO"], automationStatus: "disabled", policyStatus: "disabled-by-policy", enabled: false, rssAvailable: true, apiAvailable: false,
  ...
  "pokemon-champions-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "competition"], gameTitles: ["Pokémon Champions"], automationStatus: "pending", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-unite-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "event", "competition", "anime-video"], gameTitles: ["Pokémon UNITE"], automationStatus: "pending", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-sleep-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "event", "collaboration"], gameTitles: ["Pokémon Sleep"], automationStatus: "pending", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
    policyFinding: "公式ニュース一覧は確認できたが、RSS/APIと再利用許可を確認できない。", fetchMethod: "確認待ち", lastCheckedAt: checkedAt,
  ...
  "pokemon-masters-ex-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "event"], gameTitles: ["Pokémon Masters EX"], automationStatus: "disabled", policyStatus: "disabled-by-policy", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-tcgp-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "card", "event"], gameTitles: ["ポケポケ"], automationStatus: "pending", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
    policyFinding: "公式ニュース一覧は確認できたが、RSS/APIと再利用許可を確認できない。", fetchMethod: "確認待ち", lastCheckedAt: checkedAt,
    lastSuccessfulFetchAt: null, lastArticlePublishedAt: null, lastManualCheckedAt: null, lastManualArticleAddedAt: null, recommendedCheckDays: 7, consecutiveFailures: 0, staleAfterDays: 14,
  ...
  "pokemon-card-japan": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["card", "goods", "event", "competition"], gameTitles: [], automationStatus: "manual", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-official-youtube": {
    ...
    sourceType: "official-api", sourceKind: "official", sourcePriority: 100, official: true, categories: ["anime-video", "game", "card", "event"], gameTitles: [], automationStatus: "unsupported", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: true,
  ...
  "pokemon-official-anime": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["anime-video"], gameTitles: [], automationStatus: "manual", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-official-events": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["event", "competition", "collaboration"], gameTitles: [], automationStatus: "manual", policyStatus: "disabled-by-policy", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-company-press": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game", "goods", "event", "anime-video", "collaboration"], gameTitles: [], automationStatus: "manual", policyStatus: "pending-review", enabled: false, rssAvailable: false, apiAvailable: false,
  ...
  "pokemon-legends-news": {
    ...
    sourceType: "manual", sourceKind: "official", sourcePriority: 100, official: true, categories: ["game"], gameTitles: ["Pokémon LEGENDS"], automationStatus: "manual", policyStatus: "disabled-by-policy", enabled: false, rssAvailable: false, apiAvailable: false,
    policyFinding: "pokemon.co.jpのコンテンツ再利用制限が適用される。", fetchMethod: "管理者による公式ページ確認", lastCheckedAt: checkedAt,
  ...
  "4gamer-rss": {
    id: "4gamer-rss", name: "4Gamer.net", homepageUrl: "https://www.4gamer.net/", feedUrl: "https://www.4gamer.net/rss/index.xml",
    sourceType: "rss", sourceKind: "media", sourcePriority: 55, official: false, categories: ["game", "goods", "event", "card", "anime-video", "collaboration", "competition"], gameTitles: [],
    automationStatus: "automatic", policyStatus: "approved", enabled: true, rssAvailable: true, apiAvailable: false,
    policyFinding: "公式RSS案内でRSS配信範囲の利用を明示的に許可。記事本文・画面は取得しない。", fetchMethod: "公式RSS metadata", lastCheckedAt: checkedAt,
    lastSuccessfulFetchAt: null, lastArticlePublishedAt: null, lastManualCheckedAt: null, lastManualArticleAddedAt: null, recommendedCheckDays: null, consecutiveFailures: 0, staleAfterDays: 3,
    adminCheckUrl: "https://www.4gamer.net/rss/rss.shtml", notes: "全記事RSSからPokemon relevanceを満たす直近14日記事だけを収集。"
  },
  "inside-rss": {
    id: "inside-rss", name: "インサイド", homepageUrl: "https://www.inside-games.jp/", feedUrl: "https://www.inside-games.jp/rss/index.rdf",
    sourceType: "rss", sourceKind: "media", sourcePriority: 60, official: false, categories: ["game", "goods", "event", "card", "anime-video", "collaboration", "competition"], gameTitles: [],
    automationStatus: "automatic", policyStatus: "approved", enabled: true, rssAvailable: true, apiAvailable: false,
    policyFinding: "公式RSS一覧でメイン・任天堂・モバイルFeedをRSS reader向けに公開。RSS metadataのみ取得。", fetchMethod: "公式RSS metadata（3 Feed）", lastCheckedAt: checkedAt,
    lastSuccessfulFetchAt: null, lastArticlePublishedAt: null, lastManualCheckedAt: null, lastManualArticleAddedAt: null, recommendedCheckDays: null, consecutiveFailures: 0, staleAfterDays: 3,
    adminCheckUrl: "https://www.inside-games.jp/rss/", notes: "Feed間の同一URLをcollector内で重複排除。"
  },
  "gnews-api": {
    id: "gnews-api", name: "GNews API", homepageUrl: "https://gnews.io/", feedUrl: "https://gnews.io/api/v4/search",
    sourceType: "official-api", sourceKind: "media", sourcePriority: 40, official: false, categories: ["game", "goods", "event", "card", "anime-video", "collaboration", "competition"], gameTitles: [],
    automationStatus: "automatic", policyStatus: "approved", enabled: true, rssAvailable: false, apiAvailable: true,
    policyFinding: "API dataはsubscription planの範囲で利用可。無料プランは開発・テスト専用のため、GNEWS_API_KEYと公開運用可能なGNEWS_PLANの両方がある場合のみ取得する。", fetchMethod: "GNews Search API metadata", lastCheckedAt: checkedAt,
    lastSuccessfulFetchAt: null, lastArticlePublishedAt: null, lastManualCheckedAt: null, lastManualArticleAddedAt: null, recommendedCheckDays: null, consecutiveFailures: 0, staleAfterDays: 3,
    adminCheckUrl: "https://docs.gnews.io/endpoints/search-endpoint", notes: "lang=ja、country=jp、in=title,description。GNEWS_PLANはessential/business/enterprise/customのみ許可。API key・本文contentは保存しない。"
  }
